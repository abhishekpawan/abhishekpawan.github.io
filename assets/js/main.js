...
(function () {
  ...
  //   document.querySelector('#showmore_exp').classList.toggle('d-none');
  //   document.querySelector('.showmore').classList.add('d-none');
  // }

  document.querySelector(".marvel").onmouseenter = function () {
    document.querySelector("#pop").classList.add("show");
  };

  document.querySelector(".marvel").onmouseleave = function () {
